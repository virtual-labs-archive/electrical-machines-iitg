...
* Test Steps
  ...
  3. Select 1st harmonic and connect one terminals of red ,green and blue coils  to phase 1,phase 2 and phase 3 respectively and connect other terminals of red ,green and blue coils to neutral4.Connect the sensors to the oscilloscope, set the coil position,phase shift 1&2,select the channel,set i1,i2,i3,f1,f2,f3 , set the coil position,phase shift 1&2,phase shift 1&3,select the channel,set i1,i2,i3,f1,f2,f3  and click on Remove Single wire button
